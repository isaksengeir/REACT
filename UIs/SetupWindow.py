...
"")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 578, 681))
...
" }")
        ...
        self.Button_freq = QtWidgets.QPushButton(self.scrollAreaWidgetContents_2)
        self.Button_freq.setEnabled(True)
        self.Button_freq.setObjectName("Button_freq")
        self.horizontalLayout_10.addWidget(self.Button_freq)
...
"}")
        ...
        self.gridLayout_3.addItem(spacerItem11, 0, 0, 3, 1)
...
"}")
    ...
    def retranslateUi(self, SetupWindow):
        ...
        self.Button_freq.setText(_translate("SetupWindow", "Freq details"))
