...
"}")
        ...
        self.pushButton = QtWidgets.QPushButton(self.tab_freeze)
        self.pushButton.setObjectName("pushButton")
        self.gridLayout_15.addWidget(self.pushButton, 0, 0, 1, 1)
        self.checkBox = QtWidgets.QCheckBox(self.tab_freeze)
        self.checkBox.setObjectName("checkBox")
        self.gridLayout_15.addWidget(self.checkBox, 0, 1, 1, 1)
        self.checkBox_2 = QtWidgets.QCheckBox(self.tab_freeze)
        self.checkBox_2.setObjectName("checkBox_2")
        self.gridLayout_15.addWidget(self.checkBox_2, 0, 2, 1, 1)
...
"")
    ...
    def retranslateUi(self, SetupWindow):
        ...
        self.pushButton.setText(_translate("SetupWindow", "Invert"))
        self.checkBox.setText(_translate("SetupWindow", "Move both"))
        self.checkBox_2.setText(_translate("SetupWindow", "Move connected atoms"))
