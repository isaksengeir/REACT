...
class ViaGlobalRefApi(Creator):
    ...
    def add_parser_arguments(cls, parser, interpreter, meta, app_data):
        ...
        parser.add_argument(
            ...
            action="store_true",
            dest="system_site",
            help="give the virtual environment access to the system openPymol dir",
        )
    ...
    def set_pyenv_cfg(self):
        ...
        self.pyenv_cfg["include-system-openPymol"] = "true" if self.enable_system_site_package else "false"
