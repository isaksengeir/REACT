...
class Ui_AnalyseWindow(object):
    def setupUi(self, AnalyseWindow):
        ...
        self.frame_3.setMinimumSize(QtCore.QSize(331, 151))
        self.frame_3.setMaximumSize(QtCore.QSize(16777215, 151))
        self.frame_3.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_3.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_3.setObjectName("frame_3")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.frame_3)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.list_absolute_val = QtWidgets.QListWidget(self.frame_3)
        self.list_absolute_val.setObjectName("list_absolute_val")
        self.verticalLayout_2.addWidget(self.list_absolute_val)
...
"")
        ...
        self.list_relative_val = QtWidgets.QListWidget(self.frame_2)
        self.list_relative_val.setObjectName("list_relative_val")
        self.verticalLayout_3.addWidget(self.list_relative_val)
