...
"border-color:rgb(143, 23, 119);")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/24x24/resources/icons/plot_enediagram.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_plot_ene_diagram.setIcon(icon6)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/24x24/resources/icons/quick_delta_E.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_print_relativeE.setIcon(icon8)
