...
"")
        ...
        self.button_print_file_2 = QtWidgets.QPushButton(self.frame_4)
        self.button_print_file_2.setMinimumSize(QtCore.QSize(24, 24))
        self.button_print_file_2.setMaximumSize(QtCore.QSize(24, 24))
        self.button_print_file_2.setStyleSheet("")
        self.button_print_file_2.setText("")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/24x24/resources/icons/quick_print_SCF.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.button_print_file_2.setIcon(icon6)
        self.button_print_file_2.setIconSize(QtCore.QSize(24, 24))
        self.button_print_file_2.setFlat(True)
        self.button_print_file_2.setObjectName("button_print_file_2")
        self.gridLayout_3.addWidget(self.button_print_file_2, 0, 2, 1, 1)
        ...
        self.button_print_file.setIcon(icon7)
        ...
        self.gridLayout_3.addWidget(self.button_print_file, 0, 3, 1, 1)
